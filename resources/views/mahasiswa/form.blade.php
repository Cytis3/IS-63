            ...
            <form method="POST" action="/mahasiswa">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nim') is-invalid @enderror" id="exampleInputEmail1"
                        aria-describedby="emailHelp" name="nim" value="{{ old('nim') }}">
                    @error('nim')
                        <div class="alert">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="jurusan" class="form-control @error('jurusan') is-invalid @enderror" id="">
                        ...
                        @foreach ($jurusan as $item)
                            <option value="{{ $item->nama }}" {{ old('jurusan') == $item->nama ? 'selected' : '' }}>
                                {{ $item->nama }}</option>
                        @endforeach
                    </select>
                    @error('jurusan')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('no_handphone') is-invalid @enderror"
                        id="exampleInputEmail1" aria-describedby="emailHelp" name="no_handphone"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('domisili') is-invalid @enderror"
                        id="exampleInputEmail1" aria-describedby="emailHelp" name="domisili" value="{{ old('domisili') }}">
                    @error('domisili')
                        <div class="alert">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="radioDefault2"
                            value="Laki-Laki" {{ old('jenis_kelamin', 'Laki-Laki') == 'Laki-Laki' ? 'checked' : '' }}>
